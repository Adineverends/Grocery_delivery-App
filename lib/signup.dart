    ...
    return Scaffold(
      body: SingleChildScrollView(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text("Sign Up",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 25,color: Colors.black),),
                  SizedBox(height: 10,),
        ...
        Container(
          ...
          child: Row(
            children: [
              Text("Already have an account !",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w600,color: Colors.black),),
              SizedBox(width: 5,),
              InkWell(
                onTap: (){
                  setState(() {
                  ...
                  child: Text("Sign In",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w600,color: Colors.greenAccent),))
